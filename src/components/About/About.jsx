...
const About = () => {
    return (
        <div className='max-w-7xl mx-auto'>
            <h2 className='text-center text-5xl mb-8 uppercase bg-gradient-to-r from-orange-500 to-orange-700 bg-clip-text text-transparent'>About me</h2>
            <div className='py-20 flex items-center'>
                <div className='w-1/2'>
                    <img className='rounded-xl w-4/5' src={img} alt="about img" />
                </div>
                <div className='w-1/2'>
                    <p className='text-2xl mb-3'>Hi, </p>
