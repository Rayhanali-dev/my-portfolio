...
const Banner = () => {
    ...
    return (
        <div id='banner' className='max-w-7xl mx-auto py-10 md:py-20 md:mt-12 mt-0 px-6 md:px-0'>
            <div data-aos="flip-left" data-aos-duration="2000" className='flex flex-col md:flex-row justify-between items-center'>
                ...
                <div data-aos="flip-right" data-aos-duration="2000" className='w-full md:w-1/3 mt-6 md:mt-0'>
