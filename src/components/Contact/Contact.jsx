...
const Contact = () => {
    return (
        <div className='max-w-7xl mx-auto'>
            <h2 className='text-center text-5xl mb-8 uppercase bg-gradient-to-r from-orange-500 to-orange-700 bg-clip-text text-transparent'>Contact Me</h2>
            <div className='flex justify-between'>
                <div className='w-1/3'>
                    <h2 className='text-3xl mb-6 uppercase bg-gradient-to-r from-orange-500 to-orange-700 bg-clip-text text-transparent'>Address </h2>
                    ...
                    <div className='flex gap-3 items-center'>
                        <FaPhone className='my-2 w-5 h-5'></FaPhone>
                    ...
                    <h2 className='text-3xl mt-20 uppercase bg-gradient-to-r from-orange-500 to-orange-700 bg-clip-text text-transparent'>Follow Me</h2>
                ...
                <div className='w-2/3'>
                    <h2 className='text-3xl text-end mb-6 uppercase bg-gradient-to-r from-orange-500 to-orange-700 bg-clip-text text-transparent'>Get In Touch</h2>
                    <form>
                        <input type="text" required placeholder='Name' className='py-3 px-3 w-[48%] mr-3' />
                        <input type="email" required placeholder='Email' className='py-3 px-3 w-2/4' />
