...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_xx99k0b', 'template_fg0d5f8', form.current, 'RTZQNVMP73GNRLKln')
            .then((result) => {
            ...
            <div className='flex flex-col md:flex-row justify-between'>
                ...
                <div data-aos="flip-right" className='w-full md:w-2/3'>
                    ...
                    <form ref={form} onSubmit={sendEmail}>
                        ...
                        <input type="email" name="user_email" required placeholder='Email' className='py-3 px-3 w-full md:w-2/4' />
                        <textarea name="message" id="" cols="30" className='mt-6 w-full py-3 px-3' placeholder='Tell me more about your needs...........' rows="10"></textarea>
