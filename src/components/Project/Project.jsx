    ...
    return (
        <div className='max-w-7xl mx-auto'>
            ...
            <div className='py-20 grid grid-cols-1 md:grid-cols-2 gap-6 lg:grid-cols-3'>
                <div className='h-[580px] p-4 group rounded-xl border-4 border-orange-400'>
                    ...
                    <Link className='btn btn-info mx-2' to={`https://github.com/Rayhanali-dev/sports-camp-client`}>Client Side</Link>
                ...
                <div className='h-[580px] p-4 group rounded-xl border-4 border-orange-400'>
                    ...
                    <Link className='btn btn-info mx-2' to={`https://github.com/Rayhanali-dev/toy-market-client`}>Client Side</Link>
                    <Link className='btn btn-success' to={`https://github.com/Rayhanali-dev/toy-market-server`}>server Side</Link>
                </div>
                <div className='h-[580px] p-4 group rounded-xl border-4 border-orange-400'>
                    <img className='h-80 object-left-top duration-700 object-cover transform group-hover:object-bottom w-full' src={foxeresto} alt="" />
                    ...
                    <Link className='btn btn-info mx-2' to={`https://github.com/Rayhanali-dev/chef-recipe-client`}>Client Side</Link>
