    ...
    return (
        <div id='projects' className='max-w-7xl mx-auto px-6 md:px-0'>
            ...
            <div className='py-20 grid grid-cols-1 md:grid-cols-2 gap-6 lg:grid-cols-3'>
                <div data-aos="flip-left" data-aos-duration="500" className='p-4 group rounded-xl border-4 border-orange-400'>
                ...
                <div data-aos="flip-up" data-aos-duration="500" className='p-4 group rounded-xl border-4 border-orange-400'>
                ...
                <div data-aos="flip-right" data-aos-duration="500" className='p-4 group rounded-xl border-4 border-orange-400'>
